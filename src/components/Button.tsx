...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClassName =
    variant === "basic"
      ? "transition-color-custom rounded-[8px] bg-primary-normal px-[16px] py-[8px] text-label-bold md:text-body2-bold text-white hover:bg-primary-hover disabled:bg-fill-strong disabled:text-label-disable"
      : ""
