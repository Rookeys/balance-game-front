  ...
  return (
    <div className="flex items-center gap-2">
      <RadioGroup.Item id={id} value={value} className="h-[20px] w-[20px] rounded-full border border-gray-200">
        <RadioGroup.Indicator className="transition-color-custom flex h-full w-full items-center justify-center rounded-full bg-primary-normal hover:bg-primary-hover" />
      </RadioGroup.Item>
