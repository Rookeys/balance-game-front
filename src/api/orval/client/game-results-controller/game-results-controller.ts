...
export const getGetResultRankingInfiniteQueryOptions = <
  TData = InfiniteData<Awaited<ReturnType<typeof getResultRanking>>>,
  TError = ErrorType<unknown>
>(
  gameId: number,
  params?: GetResultRankingParams,
  options?: {
    query?: Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getResultRanking>>, TError, TData>>
...
export const getGetResultRankingUsingPageSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getResultRankingUsingPage>>,
  TError = ErrorType<unknown>
>(
  gameId: number,
  params?: GetResultRankingUsingPageParams,
  options?: {
    query?: Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof getResultRankingUsingPage>>, TError, TData>>
    request?: SecondParameter<typeof customClientInstance>
  }
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {}
...
export type GetResultRankingUsingPageSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getResultRankingUsingPage>>
>
export type GetResultRankingUsingPageSuspenseQueryError = ErrorType<unknown>

export function useGetResultRankingUsingPageSuspense<
  TData = Awaited<ReturnType<typeof getResultRankingUsingPage>>,
  TError = ErrorType<unknown>
>(
  gameId: number,
...
>(
  ...
  const queryOptions = getGetResultRankingUsingPageSuspenseQueryOptions(gameId, params, options)
